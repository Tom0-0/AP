...
{
	[TypeGuid("{2187FF0A-D565-452B-A410-C261BD0109CA}")]
	[AssociatedOnlineHelpTopic("codesys.chm::/_cds_cmd_view_watch_all_forces.htm")]
	[AssociatedOnlineHelpTopic("core.OnlineCommands.Online.chm::/Unforce_All_Selected_Restore_Values.htm")]
	public class UnforceAllSelectedRestoreValuesCommand : IStandardCommand, ICommand
	{
		private static readonly Guid GUID_ONLINECOMMANDCATEGORY = new Guid("{8DDBE3C7-2966-4ba9-A27B-7DB46265241D}");

		private static readonly string[] BATCH_COMMAND = new string[2] { "watchlist", "unforce_all_selected_restore_values" };

		public Guid Category => GUID_ONLINECOMMANDCATEGORY;

		public string Name => Strings.UnforceAllSelectedRestoreValuesCommand_Name;

		public string Description => Strings.UnforceAllSelectedRestoreValuesCommand_Description;
		...
		public void ExecuteBatch(string[] arguments)
		{
			...
			if (val != null && val is ForceListView)
			{
				((ForceListView)(object)val).UnforceAllSelected(bKeepOrRestore: true);
			}
		}
	}
}
