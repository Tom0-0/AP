...
{
    [TypeGuid("{4344C8CF-1DB3-4bf8-A609-6AC6F7C6AEAA}")]
    ...
    public class ForceValuesCommand : IStandardCommand, ICommand, IHasContextlessName
    {
        private static readonly string[] BATCH_COMMAND = new string[2] { "online", "forcevalues" };
        ...
        public string Description => ((IEngine)APEnvironment.Engine).ResourceManager.GetString(typeof(Strings), "ForceAllApplicationsCommand_Description");

        public string Name => ((IEngine)APEnvironment.Engine).ResourceManager.GetString(typeof(Strings), "ForceAllApplicationsCommand_Name");
        ...
        public string ContextlessName => ((IEngine)APEnvironment.Engine).ResourceManager.GetString(typeof(Strings), "ForceAllApplicationsCommand_ContextlessName");
        ...
        public void ExecuteBatch(string[] arguments)
        {
            ...
            if (!_bIsExecutionInProgress)
            {
                ...
                try
                {
                    ...
                    OnlineCommandHelper.ForceValues();
                }
                finally
                {
