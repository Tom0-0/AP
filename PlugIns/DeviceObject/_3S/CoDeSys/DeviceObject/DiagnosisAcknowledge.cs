...
{
	[TypeGuid("{C9272719-E5F3-46BA-AEFF-C953C48AD586}")]
	public class DiagnosisAcknowledge : IStandardCommand, ICommand
	{
		...
		{
			DiagnosisAcknowledgeHelper.ExecuteBatch(arguments, bRecursive: false);
		}
